...
export default function AdminCoursesPage() {
  ...
  const [statusFilter, setStatusFilter] = useState<
    "all" | "published" | "pending" | "draft" | "archived"
  >("all");
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-purple-100 overflow-hidden">
              ...
              {filteredCourses.map((course) => (
                <tr key={course._id} className="hover:bg-purple-50 transition">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-linear-to-br from-purple-400 to-purple-600 rounded-lg flex items-center justify-center text-white font-semibold text-sm">
                        <Image
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      {course.status !== "archived" && (
                        <button
                          onClick={() =>
                            handleStatusChange(course._id, "archived")
                          }
        ...
        <div className="px-4 py-3 border-t border-purple-100 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              className="px-3 py-1 border border-purple-200 rounded-lg text-sm text-gray-600 hover:bg-purple-50"
              disabled>
              Previous
            </button>
