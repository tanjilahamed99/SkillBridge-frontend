      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {["Home", "Courses", "Contact", "Privacy Policy", "About"].map(
              (item) => (
                <Link
                  key={item}
                  href={
          ...
          {user ? (
            <div>
              <button
                ...
                className="bg-red-600 text-white md:px-6 px-2 text-sm py-2 md:py-3 rounded-xl font-medium hover:bg-red-700 transition shadow-lg shadow-red-200 hover:shadow-red-300 flex items-center gap-2">
                Logout
              </button>
            </div>
          ) : (
